...
- (void)viewDidLoad {
    ...
    self.contentScroll.contentSize=CGSizeMake(3*self.bounds.size.width, 0);
    for (int i=0; i<3; i++) {
        SPCollectionView *collection=[[SPCollectionView alloc]initWithFrame:CGRectMake(self.contentScroll.bounds.size.width*i, 0, self.contentScroll.bounds.size.width, self.contentScroll.bounds.size.height) SceneID:i];
